    ...
    try {
      const response = await fetch("https://api.brevo.com/v3/contacts", {
        ...
        headers: {
          ...
          "api-key": "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"
        },
        body: JSON.stringify({
          email: email,
          listIds: [2],
      ...
      if (response.ok || response.status === 201) {
        setMessage({ type: "success", text: "🎉 Success! You're subscribed to our newsletter." });
        setEmail("");
      } else {
        const data = await response.json();
        if (data.code === "duplicate_parameter") {
          setMessage({ type: "success", text: "You're already subscribed! Check your inbox for our latest insights." });
          setEmail("");
        } else {
