...
export const metadata: Metadata = {
  title: "AI Marketing Training & Team Enablement | Atlas AI",
  ...
  keywords: "AI marketing training, team AI training, marketing enablement, AI workshops, logistics team training",
  alternates: {
