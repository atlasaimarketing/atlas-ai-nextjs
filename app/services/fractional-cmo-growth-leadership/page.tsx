...
export const metadata: Metadata = {
  title: "Fractional CMO Services for Logistics Companies | Atlas AI",
  ...
  keywords: "fractional CMO services, fractional chief marketing officer, part-time CMO, marketing leadership, logistics CMO",
  alternates: {
